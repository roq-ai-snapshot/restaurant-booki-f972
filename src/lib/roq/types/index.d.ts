...
export namespace Prisma {
  ...
  */
  ...
  interface orderFieldRefs {
    ...
    readonly special_request: FieldRef<'order', 'String'>;
  ...
  export type orderWhereInput = {
    ...
    special_request?: StringNullableFilter<'order'> | string | null;
  ...
  export type orderScalarWhereWithAggregatesInput = {
    ...
    special_request?: StringNullableWithAggregatesFilter<'order'> | string | null;
